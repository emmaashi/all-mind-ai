    ...
    <div ref={containerRef} className="relative min-h-screen watercolor-bg">
      ...
      <motion.nav
        ...
        <div className="container mx-auto px-4">
          <motion.section
            style={{ y: textY }}
            className="py-24 text-center mt-6 relative"
          >
            <motion.div
              animate={{
                y: [0, -20, 0],
            ...
            >
              Take your Code Presentations to the next level with
              snappify&apos;s powerful animation features.
            </motion.p>
            ...
            >
              <Button
                size="lg"
                className="bg-blue-500 hover:bg-blue-600 transform transition-all hover:scale-105"
              >
